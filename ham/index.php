...
echo "<div class ='slogan'>";
    echo "<div id ='sloganmain'>"."housing"."</div>";
    echo "<hr>";
    echo "<div id ='slogansub'>"."affordable "."<span id='grey'>housing</span> | quality "."<span id='grey'>word</span> | pop "."<span id='grey'>word</span>"."</div>";
echo "</div>";
if (!$message){
    echo user_message();
}else{
