...
elseif ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        if ($_SESSION["strength"] >= 7){
            create(dbconnect_insert(), $_POST);
            $_SESSION["usermessage"]="SUCCESS: created!";
            auditor(dbconnect_insert(),$_SESSION["id"],"reg","created new: ".getnewid(dbconnect_select(),$_POST[""]));
            echo user_message();
        }else{
        ...
        $_SESSION["usermessage"]="ERROR: Could not create: ".$e->getMessage();
        throw $e;
    }
...
echo "<input type= 'text' name ='' placeholder=''>";
echo "<br>";
