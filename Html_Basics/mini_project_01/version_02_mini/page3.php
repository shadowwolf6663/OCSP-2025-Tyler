...
echo "<title>page 3</title>";  // creating title
...
echo "<div class ='content'>";
    ...
    echo "<img src='images/begining.jfif'>"; // image
    ...
    echo "<h2>joining Anteiku</h2>"; // sub heading
    echo "<img src='images/joining%20Anteiku.jfif'>"; // image
    ...
    echo "<h2>getting captured by yakumo oomori</h2>"; // sub heading
    echo "<img src='images/captured_by_yakumo.jfif'>"; // image
    ...
    echo "<h2>kaneki losing memories</h2>"; // sub heading
    echo "<img src='images/losing_memories.jfif'>"; // image
    ...
    echo "<h2>meeting touka again and getting married</h2>"; // sub heading
    echo "<img src='images/touka_wedding.jfif'>"; // image
    ...
    echo "<h2>kaneki returns</h2>"; // sub heading
    echo "<img src='images/becomes%20centipede.jfif'>"; // image
    ...
    echo "<h2>happy ending</h2>"; // sub heading
    echo "<img src='images/end.webp'>"; // image
