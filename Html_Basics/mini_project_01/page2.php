...
echo "<h2>ken kaneki</h2>";
echo "<img src='images/ken_kaneki.webp'>";
...
echo "<br>";
echo "<h2>rize kamishiro</h2>";
echo "<img src='images/rize%20kamishiro.webp'>";
...
echo "<br>";
echo "<h2>touka kirishima</h2>";
echo "<img src='images/touka%20kirishima.webp'>";
...
echo "<br>";
echo "<h2>yoshimura</h2>";
echo "<img src='images/yoshimura.webp'>";
...
echo "<br>";
echo "<h2>hide nagachika</h2>";
echo "<img src='images/hide%20nagachika.webp'>";
echo "<p>hide nagachika is a normal human and the best friend of Ken Kaneki.</p>";
echo "<br>";
echo "<h2>yakumo oomori</h2>";
echo "<img src='images/yakumo%20oomari.webp'>";
...
echo "<br>";
echo "<h2>renji yomo</h2>";
echo "<img src='images/renji%20yama.webp'>";
...
echo "<br>";
echo "<h2>kureo mado</h2>";
echo "<img src='images/kureo%20mado.webp'>";
echo "<p>kureo mado was a First Class Ghoul Investigator and Koutarou Amon's former partner and mentor.</p>";
echo "<br>";
echo "<h2>hinami fueguchi</h2>";
echo "<img src='images/hinami%20fueguchi.webp'>";
...
echo "<br>";
echo "<h2>nishiki nishio</h2>";
echo "<img src='images/nishiki%20nishio.webp'>";
...
echo "<br>";
echo "<h2>shuu tsukiyama</h2>";
echo "<img src='images/shuu%20tsukiyama.webp'>";
