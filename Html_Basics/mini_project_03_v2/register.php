...
echo "<form method='post' action=''>";// opens a form
    echo "<input type= 'text' name ='username' placeholder='doctor'>";// creates input box
    echo "<br>"; // breaks to next line
    echo "<input type= 'datetime-local' name ='password' placeholder='date of booking'>";// creates input box
    echo "<br>";// breaks to next line
